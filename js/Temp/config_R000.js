...
// Level Colors (L1 leftmost raw parts → L6 rightmost final)
...
// Fastener link colors by prefix
...
// ECN colors
export const ECN_COLORS = {
  remove: '#ef4444', replace: '#f59e0b', add: '#10b981', modify: '#3b82f6'
};
export const ECN_ICONS = {
  remove: '✕', replace: '↻', add: '+', modify: '~'
};
